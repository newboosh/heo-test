...
| **Release Manager** | Makes go/no-go decision by aggregating signals from review, security, QA, and CI. Manages merge and release. | Gate decision (SHIP/NEEDS_WORK/BLOCKED), PR, merge status | Write code, run tests, perform reviews |
